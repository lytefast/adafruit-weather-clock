...
PATH_FONT_SMALL = cwd + "/fonts/Arial-12.bdf"
PATH_FONT_MED = cwd + "/fonts/Arial-14.bdf"

icon_spritesheet = cwd + "/weather-icons.bmp"
icon_width = 16
icon_height = 16
scrolling_text_height = 24
SCROLL_DELAY_SECS = 0.04
...
class OpenWeather_Graphics(displayio.Group):
    def __init__(
        ...
        self.small_font = bitmap_font.load_font(PATH_FONT_SMALL)
        self.medium_font = bitmap_font.load_font(PATH_FONT_MED)
    ...
    def display_weather(self, weather):
        ...
        print(f'{self.temp_text.text}: {self.description_text.text} {self.humidity_text.text} {self.wind_text.text}')
    ...
    def display_time(self, time):
        hour = time[4]
        minutes = time[5]
        self.time_text.text = f'{hour}:{minutes}'
